#This is the Wraper function that handles all the File IO operations carried out my the mappers and Reducer 
import math
import sys
from mr_per import MRPerceptron
import matplotlib.pyplot as plt
import numpy as np

# Initialise a Map-Reduce task
mr_job = MRPerceptron(args=[sys.argv[1]])
...
plt.title("Perceptron using Map-Reduce")
plt.xlabel("x1")
plt.ylabel("x2")
plt.legend(loc="upper left")

plt.savefig("../perc_out.png")
plt.show()
